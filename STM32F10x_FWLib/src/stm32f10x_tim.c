...
/**
  * @brief  Configures the TIMx's DMA Date_face.
...
/**
  * @brief  Configures the TIMx Encoder Date_face.
  * @param  TIMx: where x can be  1, 2, 3, 4, 5 or 8 to select the TIM peripheral.
  ...
  * @retval None
  */
void TIM_EncoderDate_faceConfig(TIM_TypeDef* TIMx, uint16_t TIM_EncoderMode,
...
/**
  * @brief  Enables or disables the TIMx's Hall sensor Date_face.
  * @param  TIMx: where x can be 1, 2, 3, 4, 5 or 8 to select the TIM peripheral.
  * @param  NewState: new state of the TIMx Hall sensor Date_face.
  *   This parameter can be: ENABLE or DISABLE.
  * @retval None
  */
